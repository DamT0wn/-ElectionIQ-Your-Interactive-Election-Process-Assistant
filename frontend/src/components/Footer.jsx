      ...
      <div className="section-container" style={{ padding: '40px 0' }}>
        ...
        >
          ...
          <div>
            ...
            <p style={{ fontSize: 14, color: 'var(--text-muted)', maxWidth: 260, lineHeight: 1.6 }}>
              Your interactive election process assistant. Empowering civic participation through
          ...
          <div>
            ...
            <p style={{ fontSize: 14, color: 'var(--text-muted)', lineHeight: 1.6 }}>
              ElectionIQ provides non-partisan, educational content about the election process. It
        ...
        >
          ...
          >
            ...
            <HiHeart style={{ color: '#ef4444', display: 'inline', width: 14, height: 14 }} /> for
            democracy.
          </p>
          <span
            style={{
