  ...
  return (
    <div style={{ minHeight: '100vh', paddingBottom: 80 }}>
      ...
      <div style={{
        ...
        maxWidth: 860, margin: '0 auto 48px', padding: '0 24px'
      }}>
        <div style={{
        ...
        <span style={{ fontSize: 13, color: 'var(--text-muted)', whiteSpace: 'nowrap', fontWeight: 500 }}>
      ...
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '0 24px 80px', position: 'relative' }}>
        ...
        <div style={{
          ...
          background: 'linear-gradient(to bottom, transparent 0%, rgba(99,102,241,0.6) 10%, rgba(99,102,241,0.4) 50%, rgba(99,102,241,0.6) 90%, transparent 100%)',
          pointerEvents: 'none'
        }} />
