  ...
  return (
    <div className="section-container py-12 max-w-4xl">
      <div className="text-center mb-12">
        ...
        >
          Track your progress to becoming a fully prepared voter. Mark steps as complete as you
          finish them.
        </motion.p>
      </div>
      ...
      {!user ? (
        ...
        >
          ...
          <p className="text-slate-600 dark:text-slate-400 mb-8">
            Create a free account to track your voting preparation, save your chat history, and log
            your quiz scores.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="glass-card p-6 sticky top-24">
              <h3 className="font-bold text-slate-900 dark:text-white mb-6 text-center">
                Preparation Status
              </h3>
                    ...
                    >
                      <label className="flex items-center gap-4 cursor-pointer group">
                        <div className="relative flex items-center justify-center shrink-0">
                          ...
                          >
                            <HiOutlineCheck
                              className={`w-5 h-5 transition-transform ${isCompleted ? 'scale-100 opacity-100' : 'scale-50 opacity-0'}`}
                            />
                          </div>
                        </div>
