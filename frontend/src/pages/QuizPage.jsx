...
export default function QuizPage() {
  ...
  const handleOptionSelect = async (index) => {
    ...
    try {
      ...
      setExplanation(
        typeof data === 'string' ? data : data.explanation || question.explanation || ''
      );
    } catch {
          ...
          >
            ...
            >
              ...
              <div style={{ fontWeight: 700, fontSize: 16, color: 'var(--text-primary)' }}>
                Score: <span style={{ color: 'var(--accent-primary)' }}>{stats.correct}</span> /{' '}
                {stats.total}
              </div>
            </div>
            ...
            {loading && !isAnswering ? (
              ...
              <div style={{ ...cardStyle, padding: 32, textAlign: 'center' }}>
                ...
                <button onClick={loadNextQuestion} className="btn-secondary">
                  Try Again
                </button>
              </div>
            ) : (
